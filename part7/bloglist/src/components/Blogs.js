        ...
        <div className="blogItemContainer">
            <li className="blogitem">
                ...
                >
                    ...
                    {/* <button className="toggle-blog" onClick={toggleVisibility}>
                        {buttonLabel}
                    </button> */}
                </p>
...
// const [blogTitleStyle, setBlogTitleStyle] = useState({
//     marginBottom: "1em",
// });

// const blogHeight = blog.user.username === username ? "9.5" : "7.5";
// const closingTimer = blog.user.username === username ? 520 : 440;
// const [styledDiv, setStyledDiv] = useState({
//     display: "none",
//     height: blogHeight.concat("em"),
//     overflow: "hidden",
//     willChange: "height",
...
//                         setStyledDiv({
//                             display: "block",
//                             height: height.toString().concat("em"),
//                             overflow: "hidden",
//                             willChange: "height",
//                             transition: "height 200ms ease-in-out",
//                         });
...
<p style={{ visibility: "hidden" }} id="id">
    {blog.id}
</p> */}